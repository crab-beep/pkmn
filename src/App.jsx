...
const REGIONS = {
  ...
  hoenn: {
    ...
    stages: [
      ...
      {type:"gym",    name:"Rustboro Gym",         level:14, leader:"Roxanne",   badge:"Stone Badge",   team:[{id:geodude_h=74,lv:12},{id:nosepass=299,lv:14}]},
      ...
      {type:"gym",    name:"Mauville Gym",         level:24, leader:"Wattson",   badge:"Dynamo Badge",  team:[{id:electrike=309,lv:20},{id:magneton=82,lv:22},{id:manectric=310,lv:24}]},
      {type:"route",  name:"Route 112",           level:26, pool:[278,290,322,327,331]},
      {type:"route",  name:"Mt. Chimney",         level:28, pool:[322,324,331,335,338]},
      {type:"gym",    name:"Lavaridge Gym",        level:29, leader:"Flannery",  badge:"Heat Badge",    team:[{id:slugma_e=218,lv:24},{id:magcargo=219,lv:26},{id:numel_e=322,lv:26},{id:torkoal=324,lv:29}]},
      ...
      {type:"gym",    name:"Petalburg Gym",        level:31, leader:"Norman",    badge:"Balance Badge", team:[{id:spinda=327,lv:27},{id:vigoroth=vigoroth=288,lv:27},{id:linoone=264,lv:29},{id:slaking=289,lv:31}]},
      ...
      {type:"gym",    name:"Fortree Gym",          level:33, leader:"Winona",    badge:"Feather Badge", team:[{id:swellow=277,lv:29},{id:pelipper=279,lv:30},{id:skarmory=227,lv:31},{id:altaria=334,lv:33}]},
      ...
      {type:"gym",    name:"Mossdeep Gym",         level:42, leader:"Tate & Liza",badge:"Mind Badge",  team:[{id:lunatone=337,lv:40},{id:solrock=338,lv:40},{id:xatu_e=178,lv:41},{id:claydol=344,lv:42}]},
      ...
      {type:"gym",    name:"Sootopolis Gym",       level:46, leader:"Juan",      badge:"Rain Badge",    team:[{id:luvdisc=370,lv:41},{id:whiscash=340,lv:41},{id:sealeo=364,lv:43},{id:crawdaunt=342,lv:43},{id:kingdra_h=230,lv:46}]},
      {type:"route",  name:"Victory Road",        level:48, pool:[304,335,338,357,371,373],legendary:true},
      {type:"elite4", name:"Elite Four – Sidney",  level:46, leader:"Sidney",    team:[{id:mightyena=262,lv:46},{id:cacturne=332,lv:46},{id:shiftry=275,lv:48},{id:absol=359,lv:49},{id:sharpedo=319,lv:48}]},
      {type:"elite4", name:"Elite Four – Phoebe",  level:48, leader:"Phoebe",    team:[{id:dusclops=356,lv:48},{id:banette=354,lv:49},{id:sableye=302,lv:50},{id:banette2=354,lv:49},{id:dusclops2=356,lv:51}]},
      {type:"elite4", name:"Elite Four – Glacia",  level:50, leader:"Glacia",    team:[{id:sealeo_g=364,lv:50},{id:glalie=362,lv:50},{id:sealeo_g2=364,lv:52},{id:glalie_g2=362,lv:52},{id:walrein=365,lv:53}]},
      {type:"elite4", name:"Elite Four – Drake",   level:52, leader:"Drake",     team:[{id:shelgon=372,lv:52},{id:altaria_d=334,lv:54},{id:flygon=330,lv:53},{id:flygon2=330,lv:53},{id:salamence=373,lv:55}]},
      {type:"champion",name:"Champion – Wallace",  level:58, leader:"Wallace",   badge:"Hall of Fame",  team:[{id:wailord=321,lv:57},{id:tentacruel_h=73,lv:55},{id:ludicolo=272,lv:56},{id:whiscash_h=340,lv:56},{id:gyarados_h=130,lv:56},{id:milotic=350,lv:58}]},
    ],
  },
};
